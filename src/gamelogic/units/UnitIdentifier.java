...
public class UnitIdentifier {
	...
	private static String[] names = {"appros", "assault", "constructor", "fuel",
		"genius", "minelayer", "missile", "mobdca", "repair", "rocket", "scanner", 
		"scout", "surveyor", "tank", "airtransport"};
	private static String[] files = {"SPLYTRCK", "ARTILLRY", "CONSTRCT", "FUELTRCK", 
		"ENGINEER", "MINELAYR", "MISSLLCH", "ANTIAIR", "REPAIR", "ROCKTLCH", 
		"SCANNER", "SCOUT", "SURVEYOR", "TANK", "AIRTRANS"};
